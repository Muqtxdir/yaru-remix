...
##
## options:
##     -a, --all                Optimize ALL the icons in icons/src-dark/<context> [default:0]
##     -c, --context <name>     Optimize ALL the icons in icons/src-dark/<context> and save them under icons/Yaru-remix-dark/<context>
##     -f, --file <name>        Optimize only the icon in icons/src-dark/<context>/<path> and save it under icons/Yaru-remix-dark/<context>/<name> (needs --context)
##
## NOTE:
...
# current workding directory expected to be yaru-remix-dark/icons/src-dark/scalable
CWD=$(pwd)
if [[ ! ${CWD} =~ "icons/src-dark/scalable" ]]; then
  fatal "unexpected working directory ${CWD}. Please execute the script under yaru-remix-dark/icons/src-dark/scalable folder."
fi
...
optimize() {
  ...
  OUTDIR=../../Yaru-remix-dark/scalable/${GROUP}/
  OUTPUT=../../Yaru-remix-dark/scalable/${GROUP}/${NAME}
