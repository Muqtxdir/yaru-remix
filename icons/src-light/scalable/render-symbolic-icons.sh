...
##
## options:
##     -a, --all                Optimize ALL the icons in icons/src-light/<context> [default:0]
##     -c, --context <name>     Optimize ALL the icons in icons/src-light/<context> and save them under icons/Yaru-remix-light/<context>
##     -f, --file <name>        Optimize only the icon in icons/src-light/<context>/<path> and save it under icons/Yaru-remix-light/<context>/<name> (needs --context)
##
## NOTE:
...
# current workding directory expected to be yaru-remix/icons/src-light/scalable
CWD=$(pwd)
if [[ ! ${CWD} =~ "icons/src-light/scalable" ]]; then
  fatal "unexpected working directory ${CWD}. Please execute the script under yaru-remix/icons/src-light/scalable folder."
fi
...
optimize() {
  ...
  OUTDIR=../../Yaru-remix-light/scalable/${GROUP}/
  OUTPUT=../../Yaru-remix-light/scalable/${GROUP}/${NAME}
